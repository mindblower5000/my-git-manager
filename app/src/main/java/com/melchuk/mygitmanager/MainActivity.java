...
implements NavigationView.OnNavigationItemSelectedListener, UserDataFragmentView.OnUserDataFragmentInteractionListener, ReposItemFragment.OnListFragmentInteractionListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (!popupFragment(id)) return false;
    ...
    private boolean popupFragment(int id) {
        Fragment fragment=null;
        Class fragmentClass=null;

        if (id == R.id.nav_user) {
            fragmentClass=UserDataFragmentView.class;
        } else if (id == R.id.nav_repos) {
            fragmentClass=ReposItemFragment.class;
        }
        ...
        if(fragment==null) {
            Log.d("MY_TAG","No fragment has been created.");
            return false;
        }else {
            Log.d("MY_TAG","Fragment exists.");
        }
    ...
    @Override
    public void onListFragmentInteraction(RepositoryModel item) {
