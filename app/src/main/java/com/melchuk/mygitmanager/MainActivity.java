...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, UserDataFragment.OnFragmentInteractionListener, ReposItemFragment.OnListFragmentInteractionListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_user) {
            fragmentClass=UserDataFragment.class;
